      ...
      {Array.isArray(items) && items.length > 0 ? (
        <div className="flex flex-wrap gap-2">
          {items.map((item, index) => (
            <span
              key={index}
              className="px-3 py-1 text-xs rounded-full bg-[#9900FF]/10 text-[#9900FF] font-medium"
            >
              {item}
            </span>
          ))}
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center min-h-screen">
        <ThreeDots height="50" width="50" color="#9900FF" radius="9" />
      </div>
    );
  }
        ...
        <div className="flex justify-between items-start mb-2">
          ...
          <div className="flex gap-4">
            <button
              ...
              className="flex items-center cursor-pointer gap-2 px-4 py-2 rounded-xl bg-purple-50 text-[#9900FF] font-medium border border-[#9900FF]/20 hover:bg-[#9900FF] hover:text-white transition-all shadow-sm active:scale-95"
            >
              ...
              <div>
                ...
                {descriptionData.isTruncated && (
                  <button
                    ...
                    className="mt-3 text-[#9900FF] hover:text-[#7f00d4] font-medium text-sm transition-colors flex items-center gap-1"
                  >
                    {expandedDescription ? (
                      <>
                        <span>Read less</span>
      ...
      <div className="bg-white max-w-7xl mx-auto rounded-2xl shadow-sm border border-gray-100 overflow-x-auto mt-6">
        <div className="px-6 py-5 border-b border-gray-100 flex justify-between items-center bg-gray-50/30">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-[#9900FF] hover:bg-[#7f00d4]  cursor-pointer text-white px-4 py-2 rounded-xl text-sm font-medium transition-all shadow-sm active:scale-95"
          >
          ...
          >
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                className={`px-5 py-2 cursor-pointer rounded-xl text-sm font-medium text-white transition shadow-sm active:scale-95 ${actionType === "cancelled" ? "bg-red-600 hover:bg-red-700" : "bg-[#9900FF] hover:bg-[#7f00d4]"
                  }`}
              >
                Yes, Mark {actionType}
              </button>
