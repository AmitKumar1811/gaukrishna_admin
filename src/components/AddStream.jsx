    ...
    <Dialog open={open} onClose={onClose} className="relative z-50">
      ...
      <div className="fixed inset-0 flex items-center justify-center">
        <Dialog.Panel className="w-full max-w-md bg-white rounded-xl p-6 shadow-lg">
          <Dialog.Title className="text-xl font-semibold text-[#9900FF] mb-4">
            ...
            {({ setFieldValue, errors, touched }) => (
              <Form className="space-y-4">
                ...
                <div>
                  ...
                  <Field
                    name="streamName"
                    className="w-full mt-1 px-3 py-2 border rounded-md focus:ring-[#9900FF]"
                  />
...
<div>
  ...
  <div
    ...
    className="mt-2 w-full h-40 border-2 border-dashed border-[#9900FF] rounded-xl flex items-center justify-center bg-[#FAF5FF] cursor-pointer relative overflow-hidden"
  >
    {preview ? (
      <>
        <img
      ...
      <span className="text-[#9900FF] text-sm">
  ...
  <button
    ...
    className={`col-span-2 mt-4 cursor-pointer p-3 rounded-lg font-semibold transition
      ${
        isUploading
          ? "bg-gray-400"
          : "bg-[#9900FF] text-white hover:opacity-90"
      }
    `}
  >
    {isUploading
